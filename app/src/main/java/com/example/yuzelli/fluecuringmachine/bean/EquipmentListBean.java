...
public class EquipmentListBean implements Serializable {
    ...
    public static class ListBean {
        ...
        private int state;
        private int systemdataId;
        private int coredataId;
        private int alarmId;
        ...
        public int getSystemdataId() {
            return systemdataId;
        }

        public void setSystemdataId(int systemdataId) {
            this.systemdataId = systemdataId;
        }

        public int getCoredataId() {
            return coredataId;
        }

        public void setCoredataId(int coredataId) {
