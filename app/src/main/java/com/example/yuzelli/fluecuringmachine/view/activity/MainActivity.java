...
public class MainActivity extends BaseActivity {
    ...
    private Class fragmentArray[] = {YanInfoFragment.class, InformationFragment.class, MineFragment.class};
    //定义数组来存放的按钮图片
    private int tabImageViewArray[] = {R.drawable.tab_yan, R.drawable.tab_info,
            R.drawable.tab_mine};
    //Tab选项卡的文字
    private String tabtTextViewArray[] = {"设备", "信息", "我的"};
